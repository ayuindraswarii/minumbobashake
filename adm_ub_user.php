...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Employee Administrator</title>
                            ...
                            <div class="col-md-12 padding-0">
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        <h3 align="center">Ubah Data Pekerja</h3>
                                        <hr/>
                                        <br>
                                        <?php
                                          include "koneksi.php";
                                        ...
                                        ?>
                                        <form method="POST" action="adm_up_user.php">
                                      ...
                                      <a href="adm_user.php"><button class="btn btn-md btn-danger right" type="cancel">batal</button></a>
                                      </div>
                                    </div>
                                </div>
                            </div>
