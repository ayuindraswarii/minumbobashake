                                ...
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body text-center">
                                        <h3>Bahan Minuman</h3>
                                        <hr/>
                                        <center><a href="adm_c_bahan.php" class="btn btn-primary btn-sm"><span class="fa fa-plus" style="font-size: 15px;">  Data Baru</span></a></center>
                                        <br>
                                        <table class="table table-bordered table-striped">
                                          ...
                                          <?php 
                                            include 'koneksi.php';
                                            $data = mysqli_query($konek, "SELECT * from bahan order by nama_bahan asc");
                                          ...
                                          ?>
                                            <tr>
                                              ...
                                              <td>
                                              <a href="adm_ub_bahan.php?kode_bahan=<?php echo $d['kode_bahan']; ?>" class="btn btn-warning btn-sm"><span class="fa fa-pencil"></span></a>
                                              </td>
                                              <td>
                                              <a href="adm_h_bahan.php?kode_bahan=<?php echo $d['kode_bahan']; ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                              </td>
                                            </tr>   
                                            <?php  
                                            }
