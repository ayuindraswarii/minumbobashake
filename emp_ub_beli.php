...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Transaksi Pembelian Employee</title>
                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">Data Transaksi Pembelian</h3>
                                ...
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        ...
                                        ?>
                                        <form method="POST" action="emp_up_beli.php">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Harga : </h5>
                                                  <input type="text" class="form-control" name ="harga" value = "<?php echo $d['harga'];?>" placeholder="Rp">
                                              </div>
                                          </div>
                                         <input class="btn btn-md btn-primary left" type="submit" value="simpan">
                                      </form>
                                      <a href="emp_beli.php"><button class="btn btn-md btn-danger right" type="cancel">batal</button></a>
                                      </div>
                                    </div>
                                </div>
                            </div>
