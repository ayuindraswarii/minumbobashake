                            ...
                            <div class="col-md-12 padding-0">
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        <h3 align="center">Tambah Data Pekerja</h3>
                                        <hr/>
                                        <br>
                                        <form method="POST" action="adm_cr_user.php">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Lokasi Booth :</h5>
                                                  <input type="text" class="form-control" name ="booth" placeholder="Lokasi Booth" required>
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Level : </h5>
                                                  <input type="text" class="form-control" name ="level" value = "employee">
                                              </div>
                                          </div>
