                            ...
                            <div class="col-md-12 padding-0">
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        <h3 align="center">Ubah Data Administrator</h3>
                                        <hr/>
                                        <br>
                                        <?php
                                          include "koneksi.php";
                                          $id_user = $_GET['id_user'];
                                          $data = mysqli_query($konek, "SELECT * from user where id_user='$id_user'");
                                          $d = mysqli_fetch_array($data);
                                        ?>
                                        <form method="POST" action="adm_up_adm.php">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Nama :</h5>
                                                  <input type="text" class="form-control" name ="nama_user" value = "<?php echo $d['nama_user'];?>" placeholder="Nama User">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Lokasi Booth :</h5>
                                                  <input type="text" class="form-control" name ="booth" value = "<?php echo $d['booth'];?>" placeholder="Lokasi Booth">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Level : </h5>
                                                  <input type="text" class="form-control" name ="level" value = "<?php echo $d['level'];?>" disabled>
                                              </div>
                                          </div>
                                         <input class="btn btn-md btn-primary left" type="submit" value="simpan">
                                      </form>
                                      <a href="adm_adm.php"><button class="btn btn-md btn-danger right" type="cancel">batal</button></a>
                                      </div>
                                    </div>
                                </div>
                            </div>
