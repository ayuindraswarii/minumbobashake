...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Pembelian Administrator</title>
                            ...
                            <div class="col-md-12 padding-0">
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        <h3 align="center">Ubah Data Pembelian</h3>
                                        <hr/>
                                        <?php
                                          include "koneksi.php";
                                          $kode_beli = $_GET['kode_beli'];
                                          $data = mysqli_query($konek, "SELECT * from beli where kode_beli='$kode_beli'");
                                          $d = mysqli_fetch_array($data);
                                        ?>
                                        <form method="POST" id="form1" name="form1" action="adm_up_beli.php">

                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Kode Beli :</h5>
                                                  <input type="text" class="form-control" name="kode_beli" value="<?php echo $d['kode_beli'];?>" placeholder="Kode Beli">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  ...
                                                  <select name="nama_barang">
                                                    ...
                                                    <option value="Cup 50">Cup 50</option>
                                                    <option value="Sedotan Boba">Sedotan Boba</option>
                                                    <option value="Sedotan Kecil">Sedotan Kecil</option>
                                      ...
                                      <a href="adm_beli.php"><button class="btn btn-md btn-danger right" type="cancel">batal</button></a>
                                      </div>
                                    </div>
                                </div>
                            </div>
