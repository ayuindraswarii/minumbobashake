...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Transaksi Penjualan Employee</title>
                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">Data Transaksi Penjualan</h3>
                                ...
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        ...
                                        ?>
                                        <form method="POST" id="form1" name="form1" action="emp_up_jual.php">

                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>ID User :</h5>
                                                  <input type="text" class="form-control" name="id_user" value="<?php echo $d['id_user'];?>" placeholder="ID User">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                      ...
                                      <a href="emp_jual.php"><button class="btn btn-md btn-danger right" type="cancel">batal</button></a>
                                      </div>
                                    </div>
                                </div>
                            </div>
