                            ...
                            <div class="col-md-12 padding-0">
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        <h3 align="center" align="center">Tambah Stok Bahan</h3>
                                        <hr/>
                                        <form method="POST" action="adm_cr_stok.php">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  ...
                                                  <input type="text" class="form-control" name="BDC" placeholder="BDC">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  ...
                                                  <input type="text" class="form-control" name="CRV" placeholder="CRV">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Bubuk Dark Choco : </h5>
                                                  <input type="text" class="form-control" name ="DC" placeholder="DC" >
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Bubuk Red Velvet : </h5>
                                                  <input type="text" class="form-control" name ="RV" placeholder="RV" >
                                              </div>
                                          </div>
