                                ...
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body text-center">
                                        ...
                                        <hr/>
                                        <a href="emp_c_jual.php" class="btn btn-primary btn-sm left"><span class="fa fa-plus" style="font-size: 15px;">  Transaksi</span></a>
                                        <br><br>
                                        <table class="table table-bordered table-striped">
                                          ...
                                          <?php 
                                            include 'koneksi.php';
                                            $data = mysqli_query($konek, "SELECT * from jual, minuman where jual.kode_minuman=minuman.kode_minuman order by no_nota desc");
                                          ...
                                          ?>
                                            <tr>
                                              ...
                                              <td>
                                              <center><a href="emp_ub_jual.php?no_nota=<?php echo $d['no_nota']; ?>" class="btn btn-warning btn-sm"><span class="fa fa-pencil"></span></a></center>
                                              </td>
                                              <td>
                                              <center><a href="emp_h_jual.php?no_nota=<?php echo $d['no_nota']; ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a></center>
                                              </td>
                                            </tr>   
                                            <?php  
                                            }
