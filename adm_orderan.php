                                  ...
                                  <div class="panel box-v1">
                                    <div class="panel-body text-center">
                                      ...
                                      <table class="table table-bordered table-striped">
                                        ...
                                        <?php 
                                          include 'koneksi.php';
                                          $data = mysqli_query($konek, "SELECT * from orderan order by tgl_pesan desc");
                                        ...
                                        ?>
                                          <tr>
                                            ...
                                            <td><p id="btn"></p>
                                                <button class="btn btn-danger btn-sm" id="btn" onclick="this.disabled = true;">Terima Order</button>
