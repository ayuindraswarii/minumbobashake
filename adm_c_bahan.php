                            ...
                            <div class="col-md-12 padding-0">
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        <h3 align="center">Tambah Data Bahan</h3>
                                        <hr/>
                                        <br>
                                        <form method="POST" action="adm_cr_bahan.php">

                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Kode Bahan :</h5>
                                                  <input type="text" class="form-control" name="kode_bahan" placeholder="Kode Bahan" required>
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
