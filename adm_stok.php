                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">Stok</h3>
                                ...
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body text-center">
                                        <h3>Stok Bahan Minuman</h3>
                                        <hr/>
                                        <a href="adm_c_stok.php" class="btn btn-primary btn-sm left"><span class="fa fa-plus" style="font-size: 15px;">  Barang Masuk</span></a>
                                        <br><br>
                                        <table class="table table-bordered table-striped">
                                          ...
                                          <?php 
                                            include 'koneksi.php';
                                            $data = mysqli_query($konek, "SELECT * from stok order by id_user asc");
                                          ...
                                          ?>
                                            <tr>
                                              ...
                                              <td><?php echo $d['RV']; ?></td>
                                              <td>
                                              <center><a href="adm_ub_stok.php?id_bhn=<?php echo $d['id_bhn']; ?>" class="btn btn-warning btn-sm"><span class="fa fa-pencil"></span></a></center>
                                              </td>
                                              <td>
                                              <center><a href="adm_h_stok.php?id_bhn=<?php echo $d['id_bhn']; ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a></center>
                                              </td>
                                            </tr>   
                                            <?php  
                                            }
