                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">Data Administrator</h3>
                                ...
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body text-center">
                                        ...
                                        <hr/>
                                        <center><a href="adm_c_adm.php" class="btn btn-primary btn-sm"><span class="fa fa-plus" style="font-size: 15px;">  Data Baru</span></a></center>
                                        <br>
                                        <table class="table table-bordered table-striped">
                                          ...
                                          <?php 
                                            include 'koneksi.php';
                                            $data = mysqli_query($konek, "SELECT * from user where level='admin'");
                                          ...
                                          ?>
                                            <tr>
                                              ...
                                              <td>
                                              <a href="adm_ub_adm.php?id_user=<?php echo $d['id_user']; ?>" class="btn btn-warning btn-sm"><span class="fa fa-pencil"></span></a>
                                              </td>
                                              <td>
                                              <a href="adm_h_adm.php?id_user=<?php echo $d['id_user']; ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                              </td>
                                            </tr>   
                                            <?php  
                                            }
