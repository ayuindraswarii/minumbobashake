                                ...
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        ...
                                        <hr/>
                                        <form method="POST" id="form1" name="form1" action="adm_cr_beli.php">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>No Nota :</h5>
                                                  <input type="text" class="form-control" name="kode_beli" placeholder="No Nota" required>
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Tanggal :</h5>
                                                  <input type="date" class="form-control" name ="tgl" placeholder="Nama User" required>
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Jumlah : </h5>
                                                  <input type="text" class="form-control" name ="jumlah" placeholder="Jumlah" onfocus="startCalculate()" onblur="stopCalc()" required>
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Harga : </h5>
                                                  <input type="text" class="form-control" name ="harga" placeholder="Harga" onfocus="startCalculate()" onblur="stopCalc()" required>
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Total : </h5>
                                                  <input type="text" class="form-control" name ="total" placeholder="Total" onfocus="startCalculate()" onblur="stopCalc()" required>
                                              </div>
                                          </div>
