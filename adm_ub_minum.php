...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Minuman Administrator</title>
                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">Data Minuman</h3>
                            ...
                            <div class="col-md-12 padding-0">
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        <h3 align="center">Ubah Jenis Minuman</h3>
                                        <hr/>
                                        <br>
                                        <?php
                                          include "koneksi.php";
                                          $kode_minuman = $_GET['kode_minuman'];
                                          $data = mysqli_query($konek, "SELECT * from minuman where kode_minuman='$kode_minuman'");
                                          $d = mysqli_fetch_array($data);
                                        ?>
                                        <form method="POST" action="adm_up_minum.php">

                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Kode Minuman :</h5>
                                                  <input type="text" class="form-control" name ="kode_minuman" value = "<?php echo $d['kode_minuman'];?>" placeholder="Kode Minuman">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Nama Minuman :</h5>
                                                  <input type="text" class="form-control" name ="nama_minuman" value = "<?php echo $d['nama_minuman'];?>" placeholder="Nama Minuman">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Nama Bahan :</h5>
                                                  <select name="kode_bahan" style="width: 100%;">
                                                    <option selected>Pilih</option>
                                                    <option value="BDC">Bubuk Belgium Dark Choco</option>
                                                    <option value="BG">Bubuk Bubble Gum</option>
                                                    <option value="CRV">Bubuk Choco Red Velvet</option>
                                                    <option value="DC">Bubuk Dark Choco</option>
                                                    <option value="RV">Bubuk Red Velvet</option>
                                                  </select>
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Harga : </h5>
                                                  <input type="text" class="form-control" name ="harga" value = "12000" placeholder="Rp">
                                              </div>
                                          </div>
                                         <input class="btn btn-md btn-primary" type="submit" value="simpan">
                                      </form>
                                      <a href="adm_minum.php"><button class="btn btn-md btn-danger right" type="cancel">batal</button></a>
                                      </div>
                                    </div>
                                </div>
                            </div>
