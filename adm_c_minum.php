                            ...
                            <div class="col-md-12 padding-0">
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        <h3 align="center">Tambah Data Minuman</h3>
                                        <hr/>
                                        <br>
                                        <form method="POST" action="adm_cr_minum.php">

                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Kode Minuman :</h5>
                                                  <input type="text" class="form-control" name="kode_minuman" placeholder="Kode Minuman" required>
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Nama Minuman :</h5>
                                                  <input type="text" class="form-control" name ="nama_minuman" placeholder="Nama Minuman" required>
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
