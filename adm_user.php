                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">Data Pekerja</h3>
                                ...
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body text-center">
                                        <h3>Data Pekerja</h3>
                                        <hr/>
                                        <center><a href="adm_c_user.php" class="btn btn-primary btn-sm"><span class="fa fa-plus" style="font-size: 15px;">  Data Baru</span></a></center>
                                        <br>
                                        <table class="table table-bordered table-striped">
                                          ...
                                          <?php 
                                            include 'koneksi.php';
                                            $data = mysqli_query($konek, "SELECT * from user where level='employee'");
                                            while ($d = mysqli_fetch_array($data)) {
                                          ?>
                                            <tr>
                                              <td><?php echo $d['id_user']; ?></td>
                                              <td><?php echo $d['nama_user']; ?></td>
                                              <td><?php echo $d['booth']; ?></td>
                                              <td><?php echo $d['username']; ?></td>
                                              <td><?php echo $d['password']; ?></td>
                                              <td><?php echo $d['level']; ?></td>
                                              <td>
                                              <a href="adm_ub_user.php?id_user=<?php echo $d['id_user']; ?>" class="btn btn-warning btn-sm"><span class="fa fa-pencil"></span></a>
                                              </td>
                                              <td>
                                              <a href="adm_h_user.php?id_user=<?php echo $d['id_user']; ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                              </td>
                                            </tr>   
                                            <?php  
                                            }
