                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">Data Bahan Minuman</h3>
                            ...
                            <div class="col-md-12 padding-0">
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        <h3 align="center">Stok Bahan Minuman</h3>
                                        <hr/>
                                        <?php
                                          include "koneksi.php";
                                          $id_bhn = $_GET['id_bhn'];
                                          $data = mysqli_query($konek, "SELECT * from stok where id_bhn='$id_bhn'");
                                          $d = mysqli_fetch_array($data);
                                        ?>
                                        <form method="POST" action="adm_up_stok.php">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Bubuk Belgium Dark Choco :</h5>
                                                  <input type="text" class="form-control" name ="BDC" value = "<?php echo $d['BDC'];?>" placeholder="BDC">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Bubuk Bubble Gum :</h5>
                                                  <input type="text" class="form-control" name ="BG" value = "<?php echo $d['BG'];?>" placeholder="BG">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Bubuk Chocolate Red Velvet : </h5>
                                                  <input type="text" class="form-control" name ="CRV" value = "<?php echo $d['CRV'];?>" placeholder="CRV">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Bubuk Dark Choco : </h5>
                                                  <input type="text" class="form-control" name ="DC" value = "<?php echo $d['DC'];?>" placeholder="DC">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Bubuk Red Velvet : </h5>
                                                  <input type="text" class="form-control" name ="RV" value = "<?php echo $d['RV'];?>" placeholder="RVR">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>ID Masuk :</h5>
                                                  <input type="text" class="form-control" name="id_bhn" value="<?php echo $d['id_bhn'];?>">
                                              </div>
                                          </div>
                                         <input class="btn btn-md btn-primary left" type="submit" value="simpan">
                                      </form>
                                      <a href="adm_stok.php"><button class="btn btn-md btn-danger right" type="cancel">batal</button></a>
                                      </div>
                                    </div>
                                </div>
                            </div>
