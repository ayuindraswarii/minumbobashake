...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Bahan Administrator</title>
                            ...
                            <div class="col-md-12 padding-0">
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body">
                                        <h3 align="center">Ubah Bahan Minuman</h3>
                                        <hr/>
                                        <br>
                                        <?php
                                          include "koneksi.php";
                                          $kode_bahan = $_GET['kode_bahan'];
                                          $data = mysqli_query($konek, "SELECT * from bahan where kode_bahan='$kode_bahan'");
                                          $d = mysqli_fetch_array($data);
                                        ?>
                                        <form method="POST" action="adm_up_bahan.php">

                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Kode Bahan :</h5>
                                                  <input type="text" class="form-control" name ="kode_bahan" value="<?php echo $d['kode_bahan'];?>" placeholder="Kode Bahan">
                                              </div>
                                          </div>
                                          <div class="form-group row">
                                              <div class="col-sm-12 mb-3 mb-sm-0">
                                                  <h5>Nama :</h5>
                                                  <input type="text" class="form-control" name ="nama_bahan" value = "<?php echo $d['nama_bahan'];?>" placeholder="Nama Bahan">
                                              </div>
                                          </div>
                                         <input class="btn btn-md btn-primary left" type="submit" value="simpan">
                                      </form>
                                      <a href="adm_bahan.php"><button class="btn btn-md btn-danger right" type="cancel">batal</button></a>
                                      </div>
                                    </div>
                                </div>
                            </div>
