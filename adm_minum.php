                                ...
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                      <div class="panel-body text-center">
                                        <h3>Jenis Minuman</h3>
                                        <hr/>
                                        <center><a href="adm_c_minum.php" class="btn btn-primary btn-sm"><span class="fa fa-plus" style="font-size: 15px;">  Data Baru</span></a></center>
                                        <br>
                                        <table class="table table-bordered table-striped">
                                          ...
                                          <?php 
                                            include 'koneksi.php';
                                            $data = mysqli_query($konek, "SELECT * from minuman, bahan where bahan.kode_bahan=minuman.kode_bahan order by nama_minuman asc");
                                            while ($d = mysqli_fetch_array($data)) {
                                          ?>
                                            <tr>
                                              <td><?php echo $d['kode_minuman']; ?></td>
                                              <td><?php echo $d['nama_minuman']; ?></td>
                                              <td><?php echo $d['nama_bahan']; ?></td>
                                              <td><?php echo $d['harga']; ?></td>
                                              <td>
                                              <a href="adm_ub_minum.php?kode_minuman=<?php echo $d['kode_minuman']; ?>" class="btn btn-warning btn-sm"><span class="fa fa-pencil"></span></a>
                                              </td>
                                              <td>
                                              <a href="adm_h_minum.php?kode_minuman=<?php echo $d['kode_minuman']; ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                              </td>
                                            </tr>   
                                            <?php  
                                            }
